...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@VAANIXUSERBOT_OFFICIAL"))
            await idk(functions.channels.JoinChannelRequest(channel="@VAANIXUSERBOT_OFFICIALCHAT"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@VAANIXUSERBOT_OFFICIAL"))
            await ydk(functions.channels.JoinChannelRequest(channel="@VAANIXUSERBOT_OFFICIALCHAT"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@VAANIXUSERBOT_OFFICIAL"))
            await wdk(functions.channels.JoinChannelRequest(channel="@VAANIXUSERBOT_OFFICIALCHAT"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@VAANIXUSERBOT_OFFICIAL"))
            await hdk(functions.channels.JoinChannelRequest(channel="@VAANIXUSERBOT_OFFICIALCHAT"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@VAANIXUSERBOT_OFFICIAL"))
            await sdk(functions.channels.JoinChannelRequest(channel="@VAANIXUSERBOT_OFFICIALCHAT"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@VAANIXUSERBOT_OFFICIAL"))
            await adk(functions.channels.JoinChannelRequest(channel="@VAANIXUSERBOT_OFFICIALCHAT"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@VAANIXUSERBOT_OFFICIAL"))
            await bdk(functions.channels.JoinChannelRequest(channel="@VAANIXUSERBOT_OFFICIALCHAT"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@VAANIXUSERBOT_OFFICIAL"))
            await cdk(functions.channels.JoinChannelRequest(channel="@VAANIXUSERBOT_OFFICIALCHAT"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@VAANIXUSERBOT_OFFICIAL"))
            await ddk(functions.channels.JoinChannelRequest(channel="@VAANIXUSERBOT_OFFICIALCHAT"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@VAANIXUSERBOT_OFFICIAL"))
            await edk(functions.channels.JoinChannelRequest(channel="@VAANIXUSERBOT_OFFICIALCHAT"))
...
print(text)
print("")
print("Pawri💥! Your KINGBOT SPAM BOT IS DEPLOYED AND WORKING ⚡⚡ ENJOY SPAM ⚡SUPPORT⚡ - @VAANIXUSERBOT_OFFICIAL.")
...
@idk.on(events.NewMessage(pattern=r"\.help"))
@ydk.on(events.NewMessage(pattern=r"\.help"))
@wdk.on(events.NewMessage(pattern=r"\.help"))
@hdk.on(events.NewMessage(pattern=r"\.help"))
@sdk.on(events.NewMessage(pattern=r"\.help"))
@adk.on(events.NewMessage(pattern=r"\.help"))
@bdk.on(events.NewMessage(pattern=r"\.help"))
@cdk.on(events.NewMessage(pattern=r"\.help"))
@edk.on(events.NewMessage(pattern=r"\.help"))
@ddk.on(events.NewMessage(pattern=r"\.help"))
async def help_command(event):
    help_text = (
        "**VaaniBot Help Menu**\n\n"
        ".help - Show this help message\n"
        ".bio - Set bio (for all sessions)\n"
        ".join - Join a group/channel (likely usage)\n"
        ".raid - Start raid message spam (if enabled)\n"
        ".rraid - Start reverse raid spam (if enabled)\n"
        "\nBot developed by @VAANIXUSERBOT_OFFICIAL"
    )
